...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sump', models.IntegerField(default=0, verbose_name='购买人数')),
                ('name', models.CharField(max_length=32, verbose_name='商品名称')),
                ('director', models.CharField(max_length=32, verbose_name='商家名称')),
                ('country', models.CharField(max_length=32, verbose_name='国家')),
                ('years', models.CharField(max_length=32, verbose_name='年份')),
                ('leader', models.CharField(max_length=32, verbose_name='价格')),
                ('d_rate', models.CharField(max_length=32, verbose_name='淘宝评分')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('products', models.IntegerField(default=0, verbose_name='商品数量')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='user.Product', verbose_name='商品id')),
        ...
        migrations.AddField(
            model_name='product',
            name='collect',
            field=models.ManyToManyField(blank=True, to='user.User', verbose_name='购买者'),
        ),
        migrations.AddField(
            model_name='product',
            name='tags',
